...
//        try {
//            Log.e("getData", new Gson().toJson(remoteMessage.getNotification()));
...
//            String id = object.getString("sound");
//            SharedPreferences sharePreference = getApplicationContext().getSharedPreferences("FoodApp", 0);
//            sharePreference.edit().putString("newOderID", id).apply();
//            showNotifications(getString(R.string.app_name), title, message);
//            Log.d("QWERTYUIOP", object.toString());
//            mp = MediaPlayer.create(getApplicationContext(), R.raw.foodorder);
//            mp.start();
