...
internal class HomeTransactionAdapter(
    var context: Context,
    var data: List<TransactionPojo>?
) :
    RecyclerView.Adapter<HomeTransactionAdapter.MyViewHolder>() {


    internal inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        var tv_description: TextView = view.findViewById(R.id.tv_description)
        var ll_line: LinearLayout = view.findViewById(R.id.ll_line)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.ll_line.setBackgroundColor(getColor(context, R.color.light_text_gray))
        ...
        if (transactionType.equals("withdrawal", ignoreCase = false)) {
            holder.tv_amount.setTextColor(getColor(context, R.color.red))
     ...
     */          holder.civ_transactImage.background = getDrawable(context, R.drawable.withdraw)
            ...
            holder.tv_amount.setTextColor(getColor(context, R.color.green))
